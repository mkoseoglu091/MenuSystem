...
void AMenuSystemCharacter::CreateGameSession()
{
	...
	// If there is an existing session, destroy that session before creating new session
...
void AMenuSystemCharacter::JoinGameSession()
{
	...
	SessionSearch->MaxSearchResults = 10000; // I don't have a personal dev app ID, and I'm using steams test dev ID 480. Lots of other people use this so I need high max results
...
void AMenuSystemCharacter::OnCreateSessionComplete(FName SessionName, bool bWasSuccessful)
{
	...
	else
	{
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Red, FString("Failed to create a session!"));
		}
	}
}
